...
- Applies a taint with the specified key and value to the specified node with the specified taint effect.
...
- By default, the master node has a taint on it so it won't be able to accept workload pods.
