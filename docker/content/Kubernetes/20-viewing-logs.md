...
- Print logs from the specified pod.

```sh
kubectl logs <pod-name> <container-name>
```

- Print logs from the specified pod in the specified container.

```sh
kubectl logs -f <pod-name>
```

- Stream logs from the specified pod.

```sh
kubectl logs -f <pod-name> <container-name>
```

- Stream logs from the specified pod in the specified container.
