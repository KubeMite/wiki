...
1. **Add the Repository** - Add the repository containing the chart to your local Helm setup:
...
1. **Deploy the Application** - Install the chart to deploy the application in your Kubernetes cluster:
...
1. **List All Releases** - To see all existing releases, use:
...
1. **Uninstall the Application** - To uninstall and remove a deployed application:
